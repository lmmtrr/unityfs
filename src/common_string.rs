pub fn get_common_string(id: u32) -> Option<&'static str> {
    match id {
        0 => Some("AABB"),
        ...
        1152 => Some("FileSize"),
        1161 => Some("Hash128"),
        1169 => Some("RepeatableConfigurableElement"),
        1199 => Some("SecondarySpriteTexture"),
        1222 => Some("SecondarySpriteTextures"),
        _ => None,
    }
}
